...
import { validateDeliveryOption } from "../../data/deliveryOptions.js";
...
describe('test suite: removeFromCart', () => {
   ...
   it('remove a productId, that is not in the cart', () => {
    ...
    loadFromStorage();
    removeFromCart('e43634am-6fb0-4b85-b27f-e1d07eb678c6');
...
describe('test suite: for updateDeliveryOption()', () => {
  ...
  it('understand that id does not exist', () => {
    spyOn(localStorage,'getItem').and.callFake(() => {
      return JSON.stringify([{
        productId:'e43638ce-6aa0-4b85-b27f-e1d07eb678c6',
        quantity:1,
  ...
  it('updates deliveryOption that does not exist', () => {
     spyOn(localStorage,'getItem').and.callFake(() => {
      return JSON.stringify([{
        productId:'e43638ce-6aa0-4b85-b27f-e1d07eb678c6',
        quantity:1,
